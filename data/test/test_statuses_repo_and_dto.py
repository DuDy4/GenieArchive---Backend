...
def test_insert_status():
    ...
    status = statuses_repo.get_status("123e4567-e89b-12d3-a456-426614174000", "tenant_id", "current_event")
    ...
    statuses_repo.delete_status("123e4567-e89b-12d3-a456-426614174000", "tenant_id", "current_event")
...
def test_update_status():
    ...
    status = statuses_repo.get_status("123e4567-e89b-12d3-a456-426614174001", "tenant_id", "new_event")
    ...
    statuses_repo.delete_status("123e4567-e89b-12d3-a456-426614174001", "tenant_id", "new_event")
    statuses_repo.delete_status("123e4567-e89b-12d3-a456-426614174001", "tenant_id", "current_event")
...
def test_save_status():
    ...
    status = statuses_repo.get_status("123e4567-e89b-12d3-a456-426614174003", "tenant_id", "current_event")
    ...
    assert status.status == StatusEnum.COMPLETED
    statuses_repo.delete_status("123e4567-e89b-12d3-a456-426614174003", "tenant_id", "current_event")
...
def test_get_status():
    ...
    statuses_repo.insert_status(status_dto)
    status = statuses_repo.get_status("123e4567-e89b-12d3-a456-426614174002", "tenant_id", "current_event")
    assert status.person_uuid == UUID("123e4567-e89b-12d3-a456-426614174002")
    assert status.tenant_id == "tenant_id"
    assert status.current_event == "current_event"
    assert status.current_event_start_time == datetime(2021, 1, 1, 0, 0, tzinfo=timezone.utc)
    assert status.status == StatusEnum.PROCESSING
    statuses_repo.delete_status("123e4567-e89b-12d3-a456-426614174002", "tenant_id", "current_event")
